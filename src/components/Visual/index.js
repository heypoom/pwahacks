...
import s from "./Visual.sass"

// Borrowed from LzxHahaha: https://github.com/LzxHahaha/react-dinosaur-game
...
class Play extends Component {
  constructor(props) {
    ...
    skyImage.src = "/cloud.png"
    groundImage.src = "/ground.png"
    playerImage.src = "/dinosaur.png"
    playerLeftImage.src = "/dinosaur_left.png"
    playerRightImage.src = "/dinosaur_right.png"
    playerDieImage.src = "/dinosaur_die.png"
  ...
  render = () => (
    <div className={s.root}>
      <h1>
        Unfinished Section. How about a game of dinosaur first?
        (Borrowed from LzxHahaha on GitHub)
      </h1>
